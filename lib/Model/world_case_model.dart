...
class WorldCaseModel {
  ...
  WorldCaseModel.fromJson(dynamic json) {
...
WorldCaseModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorldCaseModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
